...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("saved_amount", sa.Numeric(precision=14, scale=2), server_default="0", nullable=False),
        sa.Column("monthly_contribution", sa.Numeric(precision=14, scale=2), server_default="0", nullable=False),
